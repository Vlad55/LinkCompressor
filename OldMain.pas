...
begin
  ...
  // HHCtrl.syncURL('D:\Google Login\—окращатель ссылок\OldInterface\Help\Table of Contents.hhc');
  // HHCtrl.TextPopup('“екст подсказки','Times New Roman',5,5,clYellow,clBlue);
  // HHCtrl.Click;
  // HtmlHelpA(handle,PAnsiChar('D:\Google Login\—окращатель ссылок\OldInterface\Help\help.chm'),HH_DISPLAY_TOPIC,0)
end;
...
begin
  // измен€ем размеры и положение контролов
  ...
  // измен€ем размеры Edit'ов сервисов
